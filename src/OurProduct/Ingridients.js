  ...
  return (
    <div className="ingMainParent">
      ...
      <div className="ingImgHold flex flex-row gap-36 justify-center">
        <img src={ing1} className="zoom2" alt="ing1" />
        <img src={ing2} className="zoom2" alt="ing2" />
        <img src={ing3} className="zoom2" alt="ing3" />
        <img src={ing4} className="zoom2" alt="ing4" />
        <img src={ing5} className="zoom2" alt="ing5" />
        <img src={ing6} className="zoom2" alt="ing6" />
      </div>
